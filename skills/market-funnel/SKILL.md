...
|-------------|---------------|---------------|------------|
| **リード獲得** | サービス、代理店、B2B | ランディングページ→フォーム→サンクスページ→ナーチャリング→商談 | リード成約率 |
| **SaaSトライアル** | SaaS製品 | ホームページ→料金→登録→オンボーディング→アップグレード | トライアル有料転換率 |
| **SaaSデモ申込** | エンタープライズSaaS | ホームページ→機能→デモリクエスト→商談→成約 | デモ成約率 |
...
**摩擦の監査：**
- フォームフィールド数の確認（目標：リード獲得3〜5項目、チェックアウト5〜8項目）
